    ...
    return (
        <main className="flex-grow z-10 py-12 px-4 sm:px-6 lg:px-8 bg-background-light relative">
            ...
            <div className="mt-16 border-t border-primary/20 pt-8 relative z-10">
                ...
                <div className="relative w-full overflow-hidden bg-secondary/50 dark:bg-secondary/5 py-8 rounded-xl backdrop-blur-sm">
                    <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-secondary to-transparent z-10 pointer-events-none"></div>
                    <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-secondary to-transparent z-10 pointer-events-none"></div>
